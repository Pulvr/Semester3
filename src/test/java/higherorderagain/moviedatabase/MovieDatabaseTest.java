...
import higherorderagain.moviedatabase.Category;
import higherorderagain.moviedatabase.Movie;
import higherorderagain.moviedatabase.MovieDatabase;
...
class MovieDatabaseTest {
    ...
    private final MovieDatabase movieDatabase = new MovieDatabase(MOVIES); // inject test movies into the movie database.
